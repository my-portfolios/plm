<style type="text/css">
	...
	body {margin:0;padding:0;font-size:12px;background:#fafafa}
	...
	*/
	...
	#wp_top{
		...
		border-bottom:1px solid #<?php echo $this->config->item($this->uri->segment(1).'Color_line');?>;
		position: relative;
  	z-index: 1;
	}
		#wp_top h1{
  ...
  background-position: -0px -26px!important;
	...
	.top_etc li button{
		border:0;
		border-left: 1px solid #<?php echo $this->config->item($this->uri->segment(1).'Color_bg2');?>!important;
	...
	.top_etc li button:hover{
		background: #<?php echo $this->config->item($this->uri->segment(1).'Color_bg2');?>!important;
	}
 ...
 */
 .bg-success{
	...
	.label-info{
		background: #<?php echo $this->config->item($this->uri->segment(1).'Color_bg1');?>
	}
	.label{
...
.nav-tabs{
	...
	*/
	...
	.btn-<?php echo $this->config->item($this->uri->segment(1).'Color');?> {
	  background-image: -webkit-linear-gradient(top, #<?php echo $this->config->item($this->uri->segment(1).'Color_bg1');?> 0%, #<?php echo $this->config->item($this->uri->segment(1).'Color_bg2');?> 100%);
	  background-image: -o-linear-gradient(top, #<?php echo $this->config->item($this->uri->segment(1).'Color_bg1');?> 0%, #<?php echo $this->config->item($this->uri->segment(1).'Color_bg2');?> 100%);
	  background-image: -webkit-gradient(linear, left top, left bottom, from(#<?php echo $this->config->item($this->uri->segment(1).'Color_bg1');?>), to(#<?php echo $this->config->item($this->uri->segment(1).'Color_bg2');?>));
	  background-image: linear-gradient(to bottom, #<?php echo $this->config->item($this->uri->segment(1).'Color_bg1');?> 0%, #<?php echo $this->config->item($this->uri->segment(1).'Color_bg2');?> 100%);
	  background-repeat: repeat-x;
	  border-color: #<?php echo $this->config->item($this->uri->segment(1).'Color_line');?>;
	  color:#fff
	}
	.btn-<?php echo $this->config->item($this->uri->segment(1).'Color');?>:hover,
	.btn-<?php echo $this->config->item($this->uri->segment(1).'Color');?>:focus {
	  background-color: #<?php echo $this->config->item($this->uri->segment(1).'Color_bg2');?>;
	  background-position: 0 -15px;
	  color:#fff;
	  border-color: #<?php echo $this->config->item($this->uri->segment(1).'Color_over_line');?>;
	}
	.btn-<?php echo $this->config->item($this->uri->segment(1).'Color');?>:active,
	.btn-<?php echo $this->config->item($this->uri->segment(1).'Color');?>.active {
	  background-color: #<?php echo $this->config->item($this->uri->segment(1).'Color_bg_active');?>;
	  border-color: #<?php echo $this->config->item($this->uri->segment(1).'Color_over_line');?>;
	}
	...
	.progress-bar-<?php echo $this->config->item($this->uri->segment(1).'Color');?>{
	    ...
	    background-image: linear-gradient(to bottom, #<?php echo $this->config->item($this->uri->segment(1).'Color_bg1');?> 0%, #<?php echo $this->config->item($this->uri->segment(1).'Color_bg2');?> 100%);
	    background-repeat: repeat-x;
	    filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#ff<?php echo $this->config->item($this->uri->segment(1)."Color_bg1");?>', endColorstr='#ff<?php echo $this->config->item($this->uri->segment(1)."Color_bg2");?>', GradientType=0);
	}
	
	.bootstrap-datetimepicker-widget table td.active, 
	.bootstrap-datetimepicker-widget table td.active:hover,
	.bootstrap-datetimepicker-widget table td span.active{
		background-color: #<?php echo $this->config->item($this->uri->segment(1).'Color_bg1');?>!important;
	}
	.bootstrap-datetimepicker-widget table td.today:before{
		border-bottom-color: #<?php echo $this->config->item($this->uri->segment(1).'Color_bg1');?>!important;
	}
