...
<script>
				...
				callback: function (result) {
					if(result == true){
						...
						for(var i = 0; i < ids.length; i++){
							...
							var value = rowObject.BC_ID;     //Obejct key값이 PR_ID value값 반환
							arr.push(value);
						}
	...
	$(window).load(function(){
      ...
      mtype : "POST",             
      datatype: "json",            
      colNames:['BC_ID','카테고리명','작성자','작성일'],       
      colModel:[
          {name:'BC_ID',index:'BC_ID', width:100, align:"center", hidden:true},
          {name:'BC_NM',index:'BC_NM', width:300, align:"left",formatter:formatOpt1},
...
<div id="wp_right">
	<div class="search_area p-20 gray_border_bottom">
		...
		<div>
			...
			<button type="button" class="selectCopy btn btn-default btn-sm mt-10" onclick="selectRows('copy');">
