...
<script>
				...
				callback: function (result) {
					if(result == true){
						...
						for(var i = 0; i < ids.length; i++){
							...
							var value = rowObject.PC_ID;     //Obejct key값이 PR_ID value값 반환
							arr.push(value);
						}
						var postdata = {
							"REMOVE_ARR" :arr
	...
	$(window).load(function(){
		...
		mtype : "POST",             
		datatype: "json",            
		colNames:['PC_ID','거래처명','사업자번호','대표자명','연락처','작성자','작성일'],       
		colModel:[
			{name:'PC_ID',index:'PC_ID', width:100, align:"center", hidden:true},
			{name:'PC_NM',index:'PC_NM', width:300, align:"left",formatter:formatOpt1},
			{name:'PC_NUMBER',index:'PC_NUMBER', width:150, align:"center"},
			{name:'PC_EMP_NM',index:'PC_EMP_NM', width:100, align:"center"},
			{name:'PC_TEL',index:'PC_TEL', width:100, align:"center"},
	...
	<div class="search_area p-20 gray_border_bottom">
		<form id="frm_search" name="frm_search" method="post" onsubmit="return false;">
			...
			<select class="form-control width_100px" style="width:120px" id="searchField" name="searchField">
				...
				<option value="PC_NUMBER">사업자번호</option>
