...
<script>
				...
				callback: function (result) {
					if(result == true){
						...
						for(var i = 0; i < ids.length; i++){
							...
							var value = rowObject.PF_ID;     //Obejct key값이 PR_ID value값 반환
							arr.push(value);
						}
						var postdata = {
							"REMOVE_ARR" :arr
	...
	$(window).load(function(){
		...
		mtype : "POST",             
		datatype: "json",            
		colNames:['PF_ID','양식명','작성자','작성일'],       
		colModel:[
			{name:'PF_ID',index:'PF_ID', width:100, align:"center", hidden:true},
			{name:'PF_NM',index:'PF_NM', width:300, align:"left",formatter:formatOpt1},
			{name:'INS_NM',index:'INS_NM', width:150, align:"center"},
