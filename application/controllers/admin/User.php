...
class User extends CI_Controller {
	...
	*/
	...
	function pageModel(){ return 'User_model'; }
    ...
    if ($page > $total_pages) 
      $page=$total_pages;
	    ...
	    foreach($query as $row) {
	        $responce->rows[$i]['cell']=array($row->PE_ID,$row->PE_NM,$row->PC_NM,$row->PE_TEL,$row->PE_AUTH,$row->INS_ID,$row->INS_DT,$row->FA_CNT);
