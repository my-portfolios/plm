...
class Format_write extends CI_Controller {
	/*
	...
	*/
	...
	function pageType(){ return 'Format_write'; } //seg 2
	function pageModel(){ return 'Format_write_model'; } // model
	function pageReturn(){ return 'Format'; } //def,PLM_TYPE,return
	/*파일저장시*/
	function fileName(){ return 'PF_NM'; } //제목 name
	function fileCont(){ return 'PF_NM'; } //컨텐츠 name
	function fileKeyWord(){ return '양식관리'; } //파일저장시 pdm 키워드이름
	
	function fileId(){ return 'PF_ID';}
