...
class Board_write extends CI_Controller {
	...
	*/
	...
	function pageType(){ return 'Board_write'; } //seg 2
	function pageModel(){ return 'Board_write_model'; } // model
	function pageReturn(){ return 'Board'; } //def,PLM_TYPE,return
	/*파일저장시*/
	function fileName(){ return 'BOARD_TITLE'; } //제목 name
	function fileCont(){ return 'BOARD_TITLE'; } //컨텐츠 name
	function fileKeyWord(){ return '게시판관리'; } //파일저장시 pdm 키워드이름
	
	function fileId(){ return 'BOARD_ID';}
