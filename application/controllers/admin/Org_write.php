...
class Org_write extends CI_Controller {
	/*
	...
	*/
	...
	function pageType(){ return 'Org_write'; } //seg 2
	function pageModel(){ return 'Org_write_model'; } // model
	function pageReturn(){ return 'Org'; } //def,PLM_TYPE,return
	/*파일저장시*/
	function fileName(){ return 'ORG_NM'; } //제목 name
	function fileCont(){ return 'ORG_DATA'; } //컨텐츠 name
	function fileKeyWord(){ return '조직도'; } //파일저장시 pdm 키워드이름
	
	function fileId(){ return 'ORG_ID';}//...
